        ...
        <footer className="bg-primary-950 pt-8 sm:pt-12 md:pt-16 lg:pt-20 border-t border-white/5">
            <Container>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-16">
                    <div className="sm:col-span-2 space-y-6 sm:space-y-8">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="flex flex-col justify-center">
                                <h3 className="text-lg sm:text-xl font-bold text-white font-display leading-tight">Swift<span className="text-secondary-400">Repairs</span></h3>
                                <span className="text-slate-500 text-xs tracking-widest font-light leading-tight">UAE</span>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            <p className="text-slate-400 text-xs sm:text-sm font-light break-all">support@swiftrepairs.ae</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-white/5 py-6 sm:py-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-slate-600 text-xs font-medium tracking-wide">
                    <div className="text-center sm:text-left">&copy; {currentYear} Swift Repairs UAE. All rights reserved.</div>
